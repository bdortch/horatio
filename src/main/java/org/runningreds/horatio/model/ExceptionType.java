...
public class ExceptionType extends Type {
    ...
    public ExceptionType(ThriftModel schema, Type base, String name, List<String> docComments) {
        super(schema, base, name, Category.EXCEPTION);
        this.fields = new FieldSet(getQName());
        this.docComments = docComments;
    }
    
    public ExceptionType(ThriftModel schema, Type base, String name) {
        this(schema, base, name, (List<String>)null);
    }
    
    public ExceptionType(ThriftModel schema, String name, List<String> docComments) {
        super(schema, name, Category.EXCEPTION);
        this.fields = new FieldSet(getQName());
        this.docComments = docComments;
    }
    
    public ExceptionType(ThriftModel schema, String name) {
